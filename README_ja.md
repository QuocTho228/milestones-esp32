...
- カスタマイズ可能なウェイクワード、フォント、絵文字、チャット背景、オンラインWeb編集に対応 ([カスタムアセットジェネレーター](https://github.com/78/milestones-assets-generator))
...
ファームウェアはデフォルトで公式 [milestones.me](https://milestones.me) サーバーに接続します。個人ユーザーはアカウント登録でQwenリアルタイムモデルを無料で利用できます。
...
すでにシャオジーAIチャットボットデバイスをお持ちで、公式サーバーに接続済みの場合は、[milestones.me](https://milestones.me) コンソールで設定できます。
...
- [xinnan-tech/milestones-esp32-server](https://github.com/xinnan-tech/milestones-esp32-server) Pythonサーバー
- [joey-zhou/milestones-esp32-server-java](https://github.com/joey-zhou/milestones-esp32-server-java) Javaサーバー
- [AnimeAIChat/milestones-server-go](https://github.com/AnimeAIChat/milestones-server-go) Golangサーバー
- [hackers365/milestones-esp32-server-golang](https://github.com/hackers365/milestones-esp32-server-golang) Golangサーバー

シャオジー通信プロトコルを利用した他のクライアントプロジェクト：

- [huangjunsen0406/py-milestones](https://github.com/huangjunsen0406/py-milestones) Pythonクライアント
- [TOM88812/milestones-android-client](https://github.com/TOM88812/milestones-android-client) Androidクライアント
- [100askTeam/milestones-linux](http://github.com/100askTeam/milestones-linux) 百問科技提供のLinuxクライアント
- [78/milestones-sf32](https://github.com/78/milestones-sf32) 思澈科技のBluetoothチップファームウェア
- [QuecPython/solution-milestonesAI](https://github.com/QuecPython/solution-milestonesAI) 移遠提供のQuecPythonファームウェア
