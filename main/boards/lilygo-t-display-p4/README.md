...
- Select the board
        ...
        Milestones Assistant -> Board Type -> LILYGO T-Display-P4

- Select the screen type

        Milestones Assistant -> Select the screen type -> (Select the screen type you need to configure)

- Screen the screen pixel format

        Milestones Assistant -> Select the color format of the screen -> (Select the screen pixel format you need to configure)
...
- Flash the slave example from the esp-hosted-mcu library for the target chip ESP32C6. The esp-hosted-mcu version must match the one used in the milestones-esp32 library.
