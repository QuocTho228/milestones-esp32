...
- Select the board
        ...
        Milestones Assistant -> Board Type -> Wireless-Tag WTP4C5MP07S
...
- Flash the slave example from the esp-hosted-mcu library for the target chip ESP32C5. The esp-hosted-mcu version must match the one used in the milestones-esp32 library.
