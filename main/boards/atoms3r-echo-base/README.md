...
```text
Milestones Assistant -> Board Type -> AtomS3R + Echo Base
```
...
esptool.py --chip esp32s3 merge_bin \
    ...
    -o AtomS3R-EchoBase-Milestones-v2.2.6_0x00.bin
```

烧录合并后的固件：

```bash
esptool.py -b 1500000 write_flash -z 0 AtomS3R-EchoBase-Milestones-v2.2.6_0x00.bin
```
