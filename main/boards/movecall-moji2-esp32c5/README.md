...
This document provides instructions on how to configure and build the firmware for **Movecall Moji2.0 (Milestones AI Edition)**.
...
> **Milestones Assistant** -> **Board Type** -> **Movecall Moji2.0 小智AI衍生版**

_Note: After selecting, press **S** to save (then Enter to confirm) and press **Q** to exit._
