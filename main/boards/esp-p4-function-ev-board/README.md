...
In `menuconfig`: Milestones Assistant -> Board Type -> ESP-P4-Function-EV-Board
...
Tip: In menuconfig, choose Milestones Assistant -> Board Type -> ESP-P4-Function-EV-Board.
