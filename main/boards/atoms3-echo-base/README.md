...
```text
Milestones Assistant -> Board Type -> AtomS3 + Echo Base
```

关闭语音唤醒与音频处理：

```text
Milestones Assistant -> [ ] 启用语音唤醒与音频处理 -> Unselect
```
...
esptool.py --chip esp32s3 merge_bin \
    ...
    -o AtomS3-EchoBase-Milestones-v2.2.6_0x00.bin
```

烧录合并后的固件：

```bash
esptool.py -b 1500000 write_flash -z 0 AtomS3-EchoBase-Milestones-v2.2.6_0x00.bin
```
