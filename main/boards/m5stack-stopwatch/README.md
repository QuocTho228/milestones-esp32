...
```text
Milestones Assistant -> Board Type -> M5Stack StopWatch
```
...
```text
Milestones Assistant -> Wake Word Implementation Type -> Wakenet model with AFE
```
...
esptool.py --chip esp32s3 merge_bin \
    ...
    0x20000 build/milestones.bin \
    0x800000 build/generated_assets.bin \
    -o M5Stack-StopWatch-Milestones-v2.2.6_0x00.bin
```

烧录合并后的固件：

```bash
esptool.py -b 1500000 write_flash -z 0 M5Stack-StopWatch-Milestones-v2.2.6_0x00.bin
```
