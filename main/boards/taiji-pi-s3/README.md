...
```
Milestones Assistant -> Board Type -> 太极小派esp32s3

Milestones Assistant -> TAIJIPAI_S3_CONFIG -> taiji-pi-S3 I2S Type -> I2S Type PDM
```
...
Milestones Assistant -> TAIJIPAI_S3_CONFIG -> Enabel use 2 slot
```
