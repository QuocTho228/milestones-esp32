...
```text
Milestones Assistant -> Board Type -> M5Stack AtomS3R + Echo Pyramid
```
...
esptool.py --chip esp32s3 merge_bin \
    ...
    -o AtomS3R-EchoPyramid-Milestones-v2.2.6_0x00.bin
```

烧录合并后的固件：

```bash
esptool.py -b 1500000 write_flash -z 0 AtomS3R-EchoPyramid-Milestones-v2.2.6_0x00.bin
```
