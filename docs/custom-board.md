...
This guide describes how to add a new board to the Milestones AI voice assistant project. Milestones AI supports 70+ ESP32-series boards; each one lives in its own directory under `main/boards/`.
...
3. Select the board via menuconfig:
   ...
   Navigate to `Milestones Assistant -> Board Type` and choose your board.
