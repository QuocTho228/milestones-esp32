...
Usage:
    python download_github_runs.py 2.0.4 https://github.com/78/milestones-esp32/actions/runs/18866246016
...
def parse_github_run_url(url: str) -> tuple[str, str, str]:
    ...
    """
    # Example: https://github.com/78/milestones-esp32/actions/runs/18866246016
...
def rename_artifact(original_name: str, version: str) -> str:
    ...
    Rules:
    - Remove "milestones_" prefix
    - Remove hash suffix (underscore followed by hex string)
    - Add version prefix (e.g., "v2.0.4_")
    - Add .zip extension
    
    Examples:
        milestones_atk-dnesp32s3-box0_43ef2f4e7f0957dc62ec7d628ac2819d226127b8
        -> v2.0.4_atk-dnesp32s3-box0.zip
        
        milestones_waveshare-esp32-p4-nano-10.1-a_43ef2f4e7f0957dc62ec7d628ac2819d226127b8
    ...
    # Remove "milestones_" prefix
    name = original_name
    if name.startswith("milestones_"):
        name = name[len("milestones_"):]
