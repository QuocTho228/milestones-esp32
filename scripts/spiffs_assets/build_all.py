...
wn9_nihaomilestones_tts-font_puhui_common_20_4-emojis_32.bin
"""
...
def build_assets(wakenet_model, text_font, emoji_collection, build_dir, final_dir):
    ...
    if text_font != "none":
        text_font_path = os.path.join("../../components/78__milestones-fonts/cbin", f"{text_font}.bin")
        cmd.extend(["--text_font", text_font_path])
    
    if emoji_collection != "none":
        emoji_path = os.path.join("../../components/milestones-fonts/build", emoji_collection)
...
def main():
    ...
    wakenet_models = [
        "none",
        "wn9_nihaomilestones_tts",
        "wn9s_nihaomilestones"
    ]
